...
import { Menu, GitBranch, FolderOpen, History, Settings, GitMerge, RefreshCw, GitCompare, MoreHorizontal, Network } from 'lucide-react';
import { useState } from 'react';
import { DropdownMenu, DropdownMenuContent, DropdownMenuItem, DropdownMenuTrigger, MobileDropdownContent } from '@/components/ui/dropdown-menu';
                ...
                <div className="md:hidden">
                    {isMobile ? (
                        <Drawer open={showMobileMenu} onOpenChange={setShowMobileMenu}>
                            ...
                            <MobileDropdownContent title="Navigation">
