...
const docTemplate = `{
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/models.RepoDirectoryListing"
                        }
                    }
                }
            }
        },
        "/api/repos/{id}/files/{filepath}": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
    ...
    "definitions": {
        "auth.DeviceTokenRecord": {
            ...
            "properties": {
                "createdAt": {
                    "description": "Token creation time in RFC3339 format",
                    "type": "string"
                },
                "deviceId": {
                ...
                "lastUsedAt": {
                    "description": "Last time the token was used for authentication in RFC3339 format",
                    "type": "string"
                },
                "revokedAt": {
                    "description": "Time when the token was revoked in RFC3339 format",
                    "type": "string"
                },
                "tokenHash": {
                    "description": "SHA-256 hash of the bearer token (hex-encoded)",
                    "type": "string"
                }
            }
        },
